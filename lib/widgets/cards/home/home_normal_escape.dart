...
class HomeNormalEscape extends StatelessWidget{
  final EscapeRoom mission;
  Size screen_size = const Size(200, 150);

  HomeNormalEscape({Key? key, required this.mission}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    double cardWidth = AppSizing.normal_cardWidth;
    double cardHeight = AppSizing.normal_cardHeight;
                        ...
                        child: CachedNetworkImage(
                            ...
                            errorWidget: (context, url, error) =>
                                CachedNetworkImage(
                                    ...
                                    height: AppSizing.normal_cardImageHeight,
                                    width: AppSizing.normal_cardWidth,
                                    fit: BoxFit.cover),
                            height: AppSizing.normal_cardImageHeight,
                            width: AppSizing.normal_cardWidth,
                            fit: BoxFit.cover)
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        mission.name,
                        style: AppTextStyles.escapeNormalCardEscapeName,
                        maxLines: 1,
                      ...
                      Text(
                        mission.description,
                        style: AppTextStyles.escapeNormalCardDescription,
                        maxLines: AppTextStyles.escapeNormalCardDescriptionMaxLines,
                        overflow: TextOverflow.ellipsis,
                      ),
